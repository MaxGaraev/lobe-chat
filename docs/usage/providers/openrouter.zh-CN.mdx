---
title: 在 GDZ.WORKS 中使用 OpenRouter API Key
description: 学习如何在 GDZ.WORKS 中注册、创建 API Key、充值信用额度并配置 OpenRouter，以便开始使用多种优秀大语言模型 API。
tags:
  - OpenRouter
  - API Key
  - Web UI
...
本文档将指导你如何在 GDZ.WORKS 中使用 OpenRouter:
...
<Steps>
  ...
  - 在弹出对话框中为 API 密钥取一个名字，例如 "GDZ.WORKS Key"
  ...
  ### 步骤四：在 GDZ.WORKS 中配置 OpenRouter
...
至此你已经可以在 GDZ.WORKS 中使用 OpenRouter 提供的模型进行对话了。
