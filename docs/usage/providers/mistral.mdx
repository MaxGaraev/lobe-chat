---
title: Using Mistral AI API Key in GDZ.WORKS
description: >-
  Learn how to integrate Mistral AI into GDZ.WORKS for enhanced conversational
...
# Using Mistral AI in GDZ.WORKS

The Mistral AI API is now available for everyone to use. This document will guide you on how to use [Mistral AI](https://mistral.ai/) in GDZ.WORKS:
...
<Steps>
  ...
  ### Step 2: Configure Mistral AI in GDZ.WORKS
...
You can now engage in conversations using the models provided by Mistral AI in GDZ.WORKS.
