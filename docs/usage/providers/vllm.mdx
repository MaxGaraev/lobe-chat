---
title: Using vLLM API Key in GDZ.WORKS
description: Learn how to configure and use the vLLM language model in GDZ.WORKS, obtain an API key, and start a conversation.
tags:
  - GDZ.WORKS
  - vLLM
  - API Key
...
This document will guide you on how to use vLLM in GDZ.WORKS:
...
<Steps>
  ...
  ### Step 4: Configure vLLM in GDZ.WORKS
...
Now you can use the models provided by vLLM in GDZ.WORKS to have conversations.
