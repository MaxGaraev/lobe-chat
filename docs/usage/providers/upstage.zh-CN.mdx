---
title: 在 GDZ.WORKS 中使用 Upstage
description: 学习如何在 GDZ.WORKS 中配置和使用 Upstage 的API Key，以便开始对话和交互。
tags:
  - GDZ.WORKS
  - Upstage
  - API密钥
...
至此你已经可以在 GDZ.WORKS 中使用 Upstage 提供的模型进行对话了。
