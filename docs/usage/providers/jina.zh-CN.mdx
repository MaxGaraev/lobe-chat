---
title: 在 GDZ.WORKS 中使用 Jina AI API Key
description: 学习如何在 GDZ.WORKS 中配置和使用 Jina AI 模型，获取 API 密钥并开始对话。
tags:
  - GDZ.WORKS
  - Jina AI
  - API密钥
...
至此你已经可以在 GDZ.WORKS 中使用 Jina AI 提供的模型进行对话了。
