---
title: 在 GDZ.WORKS 中使用腾讯云 API Key
description: 学习如何在 GDZ.WORKS 中配置和使用腾讯云 AI 模型，获取 API 密钥并开始对话。
tags:
  - GDZ.WORKS
  - 腾讯云
  - API密钥
...
本文档将指导你如何在 GDZ.WORKS 中接入腾讯云的 AI 模型:
...
至此你已经可以在 GDZ.WORKS 中使用腾讯云提供的模型进行对话了。
