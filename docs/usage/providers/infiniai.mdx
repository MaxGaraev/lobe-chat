---
title: Using Infini-AI in GDZ.WORKS
description: Learn how to configure and utilize Infini-AI's model services in GDZ.WORKS.
tags:
  - GDZ.WORKS
  - Infini-AI
  - API Key
...
This guide will help you quickly integrate Infini-AI's AI capabilities into GDZ.WORKS.
...
<Steps>
  ...
  ### Step 2: Configure GDZ.WORKS Model Service

  - Open GDZ.WORKS and go to the "Settings" interface
