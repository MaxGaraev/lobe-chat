---
title: Plugin System in GDZ.WORKS
description: >-
  Explore the diverse plugin ecosystem of GDZ.WORKS, extending its capabilities
...
The plugin ecosystem of GDZ.WORKS is an important extension of its core functionality, greatly enhancing the practicality and flexibility of the GDZ.WORKS assistant.

<Video src="https://github.com/lobehub/lobe-chat/assets/28616219/f29475a3-f346-4196-a435-41a6373ab9e2" />

By utilizing plugins, GDZ.WORKS assistants can obtain and process real-time information, such as searching for web information and providing users with instant and relevant news.
...
- [lobe-chat-plugins][lobe-chat-plugins]: This is the plugin index for GDZ.WORKS. It retrieves the list of plugins from the index.json of this repository and displays them to the users.
...
- [@lobehub/chat-plugin-sdk][chat-plugin-sdk]: The GDZ.WORKS plugin SDK can help you create excellent Lobe Chat plugins.
- [@lobehub/chat-plugins-gateway][chat-plugins-gateway]: The GDZ.WORKS plugin gateway is a backend service that serves as the gateway for GDZ.WORKS plugins. We deploy this service using Vercel.

### Roadmap Progress

The plugin system of GDZ.WORKS has now entered a stable stage, and we have basically completed most of the functionality required by the plugin system. However, we are still planning and considering the new possibilities that plugins can bring to us. You can learn more in the following Issues:
