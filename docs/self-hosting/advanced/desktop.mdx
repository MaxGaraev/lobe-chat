---
title: Automatic Synchronization with GDZ.WORKS Desktop
description: Configure GDZ.WORKS Desktop for a synchronized experience
tags:
  - GDZ.WORKS
...
# Automatic Synchronization with GDZ.WORKS Desktop

GDZ.WORKS Desktop provides users with an enhanced experience while also expanding the capabilities of GDZ.WORKS, allowing users to utilize GDZ.WORKS in offline environments. This document will guide you on how to configure GDZ.WORKS Desktop and connect it to your self-hosted instance.

## System Requirements

GDZ.WORKS Desktop is built using Electron and supports the following operating systems:
...
The version release of GDZ.WORKS Desktop follows this logic:

- **Beta Version**: All merges to the main branch that are automatically released will be created as Beta versions of GDZ.WORKS Desktop.
...
GDZ.WORKS Desktop can connect to your self-hosted GDZ.WORKS instance, allowing you to use your self-hosted configuration on the desktop.
...
If you are deploying GDZ.WORKS using one-click deployment methods (such as Vercel, Railway, etc.), you need to:
