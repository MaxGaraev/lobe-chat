---
title: GDZ.WORKS 特性标志环境变量配置指南
description: 了解如何使用环境变量自定义 GDZ.WORKS 的特性标志，包括控制否启用某个功能、或者根据需要对特定用户群体或环境启用或禁用功能。
tags:
  - GDZ.WORKS
  - 环境变量
  - 配置指南
...
除了基础的环境变量配置外，GDZ.WORKS 还提供了一些特性标志（Feature Flags），用于控制是否全局启用某个功能，或者根据需要对特定用户群体或环境启用或禁用功能。
