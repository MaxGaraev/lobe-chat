...
title: >-
  ...
  Information
description: >-
  Learn how to configure the SearXNG online search functionality for GDZ.WORKS,
...
GDZ.WORKS supports configuring online search functionality for AI, allowing it to access the latest web information and provide more accurate and timely responses. The online search feature is based on the [SearXNG](https://github.com/searxng/searxng) search engine, which is a privacy-respecting metasearch engine that aggregates results from multiple search engines.

<Callout type={'info'}>
  SearXNG is an open-source metasearch engine that can be self-hosted or accessed via public instances. By configuring SearXNG, GDZ.WORKS enables AI to retrieve the latest internet information, allowing it to answer time-sensitive questions and provide up-to-date news.
</Callout>
...
You can find publicly available SearXNG instances in the [SearXNG instance list](https://searx.space/). Choose an instance that is fast and reliable, and then configure its URL in GDZ.WORKS.
...
1. Restart the GDZ.WORKS service.
...
- [GDZ.WORKS Online Search RFC Discussion](https://github.com/lobehub/lobe-chat/discussions/6447)
