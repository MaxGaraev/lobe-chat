---
title: Customizing Provider Model List in GDZ.WORKS for Deployment
description: >-
  Learn how to customize the model list in GDZ.WORKS for deployment with the
...
GDZ.WORKS supports customizing the model list during deployment. This configuration is done in the environment for each [model provider](/docs/self-hosting/environment-variables/model-provider).
