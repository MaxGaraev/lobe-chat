---
title: Deploy GDZ.WORKS with Docker Compose
description: >-
  Learn how to deploy the GDZ.WORKS service using Docker Compose. Follow
...
We provide a [Docker image][docker-release-link] for deploying the GDZ.WORKS service on your private device.
