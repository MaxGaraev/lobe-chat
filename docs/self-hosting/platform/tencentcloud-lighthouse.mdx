---
title: Deploy GDZ.WORKS on TencentCloud Lighthouse
description: >-
  Learn how to deploy the GDZ.WORKS application on TencentCloud Lighthouse,
...
# Deploy GDZ.WORKS with TencentCloud Lighthouse

If you want to deploy GDZ.WORKS on TencentCloud Lighthouse, you can follow the steps below:
