---
title: Deploy GDZ.WORKS on Alibaba Cloud
description: >-
  Learn how to deploy the GDZ.WORKS application on Alibaba Cloud, including
...
# Deploy GDZ.WORKS with Alibaba Cloud

If you want to deploy GDZ.WORKS on Alibaba Cloud, you can follow the steps below:
...
[deploy-link]: https://computenest.console.aliyun.com/service/instance/create/default?type=user&ServiceName=GDZ.WORKS%E7%A4%BE%E5%8C%BA%E7%89%88
