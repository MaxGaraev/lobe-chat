---
title: Deploy GDZ.WORKS with Railway
description: >-
  Learn how to deploy GDZ.WORKS on Railway and follow the step-by-step process.
...
# Deploy GDZ.WORKS with Railway

If you want to deploy GDZ.WORKS on Railway, you can follow the steps below:
