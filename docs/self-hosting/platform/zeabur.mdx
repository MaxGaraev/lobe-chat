---
title: Deploy GDZ.WORKS on Zeabur
description: >-
...
# Deploy GDZ.WORKS with Zeabur

If you want to deploy GDZ.WORKS on Zeabur, you can follow the steps below:
...
# Deploy GDZ.WORKS with Zeabur as serverless function
...
Since Zeabur does NOT officially support FREE users deploy containerized service, you may wish to deploy GDZ.WORKS as a serverless function service. To deploy GDZ.WORKS as a serverless function service on Zeabur, you can follow the steps below:
...
<Steps>
  ...
  ### Link your fork of GDZ.WORKS to the just created Zeabur service.
