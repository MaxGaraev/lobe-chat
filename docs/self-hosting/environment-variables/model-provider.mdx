---
title: GDZ.WORKS Model Service Providers - Environment Variables and Configuration
description: >-
...
When deploying GDZ.WORKS, a rich set of environment variables related to model service providers is provided, allowing you to easily define the model service providers to be enabled in GDZ.WORKS.
