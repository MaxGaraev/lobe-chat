---
title: Resolving `UNABLE_TO_VERIFY_LEAF_SIGNATURE` Error in GDZ.WORKS When Using Proxy
description: >-
  Learn how to bypass Node.js certificate validation to resolve certificate
  verification errors in GDZ.WORKS when using a proxy with self-signed or
