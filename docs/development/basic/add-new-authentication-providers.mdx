...
GDZ.WORKS uses [Auth.js v5](https://authjs.dev/) as the external authentication service. Auth.js is an open-source authentication library that provides a simple way to implement authentication and authorization features. This document will introduce how to use Auth.js to implement a new authentication provider.

## Add New Authentication Provider

To add a new authentication provider in GDZ.WORKS (for example, adding Okta), you need to follow the steps below:
...
Now, you can use Okta as your provider to implement the authentication feature in GDZ.WORKS.
