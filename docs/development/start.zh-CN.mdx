...
欢迎来到 GDZ.WORKS 技术开发上手指南。GDZ.WORKS 是一款基于 Next.js 框架构建的 AI 会话应用，它汇集了一系列的技术栈，以实现多样化的功能和特性。本指南将详细介绍 GDZ.WORKS 的主要技术组成，以及如何在你的开发环境中配置和使用这些技术。
...
现在，你应该可以在浏览器中看到 GDZ.WORKS 的欢迎页面。详细的环境配置指南，请参考 [开发环境设置指南](/zh/docs/development/basic/setup-development)。

## 代码风格与贡献指南

在 GDZ.WORKS 项目中，我们十分重视代码的质量和一致性。为此，我们制定了一系列的代码风格规范和贡献流程，以确保每位开发者都能顺利地参与到项目中。以下是你作为开发者需要遵守的代码风格和贡献准则。
...
GDZ.WORKS 采用 `i18next` 和 `lobe-i18n` 实现多语言支持，确保用户全球化体验。
...
为了支持开发者更好地理解和使用 GDZ.WORKS 的技术栈，我们提供了一份详尽的资源与参考列表 —— [GDZ.WORKS 资源与参考](/zh/docs/development/basic/resources) - 访问我们维护的资源列表，包括教程、文章和其他有用的链接。

我们鼓励开发者利用这些资源深入学习和提升技能，通过 [GDZ.WORKS GitHub Discussions](https://github.com/lobehub/lobe-chat/discussions) 或者 [Discord](https://discord.com/invite/AYFPHvv2jT) 加入社区讨论，提出问题或分享你的经验。
