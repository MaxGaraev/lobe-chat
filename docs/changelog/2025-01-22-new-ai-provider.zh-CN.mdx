---
title: GDZ.WORKS 推出全新 AI Provider 管理系统
description: GDZ.WORKS 焕新全新 AI Provider 管理系统，已支持自定义 AI 服务商与自定义模型
tags:
  - GDZ.WORKS
  - AI Provider
  - 服务商管理
...
我们很高兴地宣布，GDZ.WORKS 推出了全新的 AI Provider 管理系统，已经在开源版与 Cloud 版（[gdz.works](https://gdz.works)）中可用：
