---
title: GDZ.WORKS 11 月新增模型服务
description: 'GDZ.WORKS 模型服务新增支持 Gitee AI, InternLM (书生浦语), xAI, Cloudflare WorkersAI'
tags:
  - GDZ.WORKS
  - AI模型服务
  - Gitee AI
...
# GDZ.WORKS 11 月新增模型服务支持 🎉

我们很高兴地宣布，GDZ.WORKS 在 11 月份新增了以下 AI 模型服务的支持：
