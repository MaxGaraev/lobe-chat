---
title: GDZ.WORKS Supports Sharing Conversations in Text Format (Markdown/JSON)
description: >-
  GDZ.WORKS v1.28.0 introduces support for exporting conversations in Markdown
