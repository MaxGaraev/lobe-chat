---
title: >-
  GDZ.WORKS Launches Knowledge Base Feature: A New Experience in Intelligent File
  Management and Dialogue
description: >-
  GDZ.WORKS introduces a brand new knowledge base feature that supports all types
...
We are excited to announce that the highly anticipated GDZ.WORKS knowledge base feature is now officially launched! 🎉 This feature is now available in both the open-source version and the Cloud version (gdz.works).
...
All features are open-sourced on the [GitHub repository](https://github.com/lobehub/lobe-chat). We invite you to visit [GDZ.WORKS](http://gdz.works) to experience the full functionality.
