---
title: GDZ.WORKS Plugin Ecosystem - Functionality Extensions and Development Resources
description: >-
  Discover how the GDZ.WORKS plugin ecosystem enhances the utility and
  flexibility of the GDZ.WORKS assistant, along with the development resources
...
The GDZ.WORKS plugin ecosystem is a significant extension of its core functionalities, greatly enhancing the utility and flexibility of the GDZ.WORKS assistant.

<Video src="https://github.com/lobehub/lobe-chat/assets/28616219/f29475a3-f346-4196-a435-41a6373ab9e2" />

By leveraging plugins, the GDZ.WORKS assistants are capable of accessing and processing real-time information, such as searching online for data and providing users with timely and relevant insights.
