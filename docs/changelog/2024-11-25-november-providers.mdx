---
title: New Model Providers Added to GDZ.WORKS in November
description: >-
  GDZ.WORKS model providers now support Gitee AI, InternLM (ShuSheng PuYu), xAI,
...
# New Model Providers Added to GDZ.WORKS in November 🎉

We're excited to announce that GDZ.WORKS has expanded its AI model support with the following providers:
