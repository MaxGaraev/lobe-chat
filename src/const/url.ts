...
export const OFFICIAL_URL = 'https://gdz.works';
export const OFFICIAL_PREVIEW_URL = 'https://gdz.works';
export const OFFICIAL_SITE = 'https://gdz.works';
...
export const MORE_MODEL_PROVIDER_REQUEST_URL = 'i@gdz.works';

export const MORE_FILE_PREVIEW_REQUEST_URL = 'i@gdz.works';
...
export const EMAIL_SUPPORT = 'i@gdz.works';
export const EMAIL_BUSINESS = 'i@gdz.works';
